...
const itemList: Record<ItemKey, Item> = {
  ...
  zemenu_rasens: {
    ...
    imgLink: 'https://www.ulmanbots.lv/images/items/zemenu-rasens.png',
    categories: [ItemCategory.VEIKALS],
    value: 75,
    allowDiscount: true,
    removedOnUse: true,
  ...
  divainais_burkans: {
    ...
    imgLink: 'https://www.ulmanbots.lv/images/items/divainais-burkans.gif',
    categories: [ItemCategory.VEIKALS],
    value: 5000,
  ...
  divaina_makskere: {
    ...
    imgLink: 'https://www.ulmanbots.lv/images/items/divaina-makskere.gif',
    categories: [ItemCategory.VEIKALS, ItemCategory.MAKSKERE],
    value: 450,
  ...
  piena_spainis: {
    ...
    imgLink: 'https://www.ulmanbots.lv/images/items/piena-spainis.png',
    categories: [ItemCategory.VEIKALS],
    value: 25,
    allowDiscount: true,
    removedOnUse: false,
  ...
  kaku_bariba: {
    ...
    imgLink: 'https://www.ulmanbots.lv/images/items/kaku-bariba.png',
    categories: [ItemCategory.VEIKALS],
    value: 20,
    allowDiscount: true,
    removedOnUse: false,
  ...
  divaina_mugursoma: {
    ...
    imgLink: 'https://www.ulmanbots.lv/images/items/divaina-mugursoma.gif',
  ...
  kafijas_aparats: {
    ...
    imgLink: 'https://www.ulmanbots.lv/images/items/kafijas-aparats.png',
    categories: [ItemCategory.TIRGUS],
    value: 200,
  ...
  loto_makskere: {
    ...
    imgLink: 'https://www.ulmanbots.lv/images/items/loto-makskere.gif',
  ...
  luznu_makskere: {
    ...
    imgLink: 'https://www.ulmanbots.lv/images/items/luznu-makskere.png',
    categories: [ItemCategory.TIRGUS, ItemCategory.MAKSKERE],
    value: 100,
  ...
  naudas_maiss: {
    ...
    imgLink: 'https://www.ulmanbots.lv/images/items/naudas-maiss.png',
    categories: [ItemCategory.TIRGUS],
    value: 10,
    // eslint-disable-next-line func-names
  ...
  kartona_kaste: {
    ...
    imgLink: 'https://www.ulmanbots.lv/images/items/kartona-kaste.png',
  ...
  loto_zivs: {
    ...
    imgLink: 'https://www.ulmanbots.lv/images/items/loto-zivs.gif',
    categories: [ItemCategory.ZIVIS],
    value: 0,
  ...
  juridiska_zivs: {
    ...
    imgLink: 'https://www.ulmanbots.lv/images/items/juridiska-zivs.png',
    categories: [ItemCategory.ZIVIS],
    value: 50,
    removedOnUse: true,
    use: juridiska_zivs,
  ...
  divaina_zivs: {
    ...
    imgLink: 'https://www.ulmanbots.lv/images/items/divaina-zivs.gif',
    categories: [ItemCategory.ZIVIS],
    value: 60,
    removedOnUse: true,
    use: divaina_zivs,
  ...
  velo_ramis: {
    ...
    imgLink: 'https://www.ulmanbots.lv/images/items/velo-ramis.png',
    categories: [ItemCategory.OTHER],
    value: 10,
    use: velo,
  },
  velo_ritenis: {
    ...
    imgLink: 'https://www.ulmanbots.lv/images/items/velo-ritenis.png',
    categories: [ItemCategory.OTHER],
    value: 10,
    use: velo,
  },
  velo_kede: {
    ...
    imgLink: 'https://www.ulmanbots.lv/images/items/velo-kede.png',
    categories: [ItemCategory.OTHER],
    value: 10,
    use: velo,
  },
  velo_sture: {
    ...
    imgLink: 'https://www.ulmanbots.lv/images/items/velo-sture.png',
    categories: [ItemCategory.OTHER],
    value: 10,
    use: velo,
  },
  ...
  smilsu_pulkstenis: {
    ...
    imgLink: 'https://www.ulmanbots.lv/images/items/smilsu-pulkstenis.gif',
    categories: [ItemCategory.OTHER],
    value: 75,
    removedOnUse: false,
